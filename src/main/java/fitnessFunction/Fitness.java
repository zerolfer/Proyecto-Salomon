...
public class Fitness {
    ...
    /**
     * Funcion objetivo utilizada para la reduccion de controladores(hasta el numero de controladores requerido)
     * y reducir el numero de restriciones incumplidas.
     *
     * @param individuo  Solucion.
     * @param entrada    Entrada del problema.
     * @param patrones   Patrones utilizados para comprobar las restricciones.
     ...
     * @return Array: Valor de la funcion objetivo normalizado + primer objetivo normalizado + Segundo objetivo normalizado.
     */
    public static double[] fitPonderadoRestricYNumCtrlsYSimilitudYContinuidad(Solucion individuo, Entrada entrada, Patrones patrones, Parametros parametros, ParametrosAlgoritmo paramAlg) {
