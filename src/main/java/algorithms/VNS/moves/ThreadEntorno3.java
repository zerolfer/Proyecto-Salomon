...
public class ThreadEntorno3 implements Runnable {
    ...
    public ThreadEntorno3(List<Solucion> listaSoluciones, int i, Solucion individuo1, int tmnIntervalo, Patrones patrones, Entrada entrada, Parametros parametros, ParametrosAlgoritmo parametrosAlg) {
