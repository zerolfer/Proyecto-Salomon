...
public class MoveMaxCarga_3 extends MoveMaxCarga {

    public MoveMaxCarga_3(Entrada entrada, Patrones patrones, Parametros parametros, ParametrosAlgoritmo parametrosAlgoritmo) {
