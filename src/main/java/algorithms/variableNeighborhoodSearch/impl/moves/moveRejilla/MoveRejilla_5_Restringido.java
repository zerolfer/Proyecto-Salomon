...
public class MoveRejilla_5_Restringido extends MoveRejilla {

    private final int c1;
    private final int c2;

    public MoveRejilla_5_Restringido(Entrada entrada, Patrones patrones, Parametros parametros, ParametrosAlgoritmo parametrosAlgoritmo, int c1, int c2) {
