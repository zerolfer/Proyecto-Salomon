...
public class Move2 {
    ...
    public static Solucion movimientoTrabajoIntervalosAleatorios(Solucion individuo1, int granularidadMax, int granularidadMin, Patrones patrones, Entrada entrada, Parametros parametros, ParametrosAlgoritmo pa, ArrayList<String> iteracion) {
        /*
