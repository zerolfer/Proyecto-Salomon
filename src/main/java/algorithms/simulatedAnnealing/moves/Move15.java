...
public class Move15 {
	 ...
	 * 7 - gMax
	 */ 
	private static Object [] traza = {"M15", null, null, null, null, null, null, null};
	...
	public static Solucion movimiento(Solucion sol, int gMax, int gMin, Patrones patrones, Entrada entrada,
		...
		/* Trazas */
	/*	if (Logs.mLog.isTraceEnabled()) {
			Logs.mLog.trace(format_traza, traza);
			Movimiento.reset_traza(traza);
		}
		*/
		return sol2;
