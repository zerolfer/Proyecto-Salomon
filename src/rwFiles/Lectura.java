...
public class Lectura {
	/**
	 * Metodo para la lectura de un archivo de numeros separados por espacios (" "), este metodo devuelve los numeros en forma de lista.
	...
	/**
	 * Metodo para la lectura de un archivo de numeros separados por punto y coma (";"), este metodo devuelve los numeros en forma de matriz, cada fila del documento corresponde a una fila de la matriz.
	 * @param path Ruta del archivo.
