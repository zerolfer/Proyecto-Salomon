...
public class Main_VNS {
	...
	public static void main_vns(Parametros parametros, ParametrosAlgoritmo_SA parametrosAlgoritmo, Entrada entrada, Patrones patrones) {
		...
		//ArrayList<Solucion> poblacionInicial = new ArrayList<Solucion>();poblacionInicial.add(poblacionInicial1.get(0));
		ArrayList<Solucion> poblacionReducirControladores = VNS.bucleVNS(poblacionInicial,parametrosAlgoritmo,parametros,patrones,entrada);
		...
		ArrayList<Solucion> poblacionOptimizada = VNS.bucleVNS(poblacionFactible,parametrosAlgoritmo,parametros,patrones,entrada);
