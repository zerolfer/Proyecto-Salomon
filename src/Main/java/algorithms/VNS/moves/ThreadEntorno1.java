...
public class ThreadEntorno1 implements Runnable {
    ...
    public ThreadEntorno1(List<Solucion> listaSoluciones, int i, Solucion individuo1, int tmnIntervalo, Patrones patrones, Entrada entrada, Parametros parametros, ParametrosAlgoritmo parametrosAlg) {
