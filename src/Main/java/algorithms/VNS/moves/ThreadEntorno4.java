...
public class ThreadEntorno4 implements Runnable {
	...
	public ThreadEntorno4(List<Solucion> listaSoluciones,int i, Solucion individuo1, int tmnIntervalo, Patrones patrones, Entrada entrada, Parametros parametros, ParametrosAlgoritmo_SA parametrosAlg) {
