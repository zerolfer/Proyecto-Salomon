...
public class TrazasAntiguo {
    ...
    private static ArrayList<String> trazas2 = new ArrayList<>();/*Contiene las trazas completas de la evolucion del fitness (trazasFit) y otras trazas del ratio de aceptacion cada L iteracciones (trazasL)*/
    ...
    private static ArrayList<ArrayList<ArrayList<String>>> recogidaTrazas() {
        ...
        ArrayList<ArrayList<String>> mismosParametros = new ArrayList<>();
        ArrayList<ArrayList<ArrayList<String>>> todo = new ArrayList<>();
        ...
        mismosParametros = new ArrayList<>();
        e = 0;
        return todo;
    }
